...
perf
一些简单的CPU消耗的问题靠着top -H + jstack通常能解决，复杂的话就需要借助perf这种超级利器了。 默认版本的perf呢，问题在于jit后的代码是看不到的，所以用perf会看到unknown什么的，我们内部呢，有个我觉得比perf更好用的东西，就是扁鹊，具体可以找@李成栋 了解。
cat /proc/interrupts
